...
def verify_site():
    with sync_playwright() as p:
        ...
        page_light.screenshot(path="/home/jules/verification/home_light_v3.png", full_page=True)
        ...
        page_dark.screenshot(path="/home/jules/verification/home_dark_v3.png", full_page=True)
